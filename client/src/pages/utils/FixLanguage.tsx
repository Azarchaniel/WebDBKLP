            ...
            <div style={{ display: 'flex', gap: 16, alignItems: 'center', marginTop: 10 }}>
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <label style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
                        <input type="radio" name="lang" value="cs" checked={lang === 'cs'} onChange={() => setLang('cs')} />
                        Czech (čeština)
                    </label>
                    <label style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
                        <input type="radio" name="lang" value="sk" checked={lang === 'sk'} onChange={() => setLang('sk')} />
                        Slovak (slovenčina)
                    </label>
                </div>
                <label style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
                ...
                <button onClick={() => setInput("")} style={{ padding: '6px 10px', cursor: 'pointer' }}>Clear</button>
            </div>
        </>
    );
}
